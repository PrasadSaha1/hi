'''
Notes -
The x position of many widgets are centered
For example, if they are centered in the middle of the screen, the x position was found by 300 (half of the oringial screen size, changed with x_location_change) subtracted by half tie width of the widget
